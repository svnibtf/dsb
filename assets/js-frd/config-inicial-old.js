...
function CONFIG() {
		...
		atv			 				= get_url.atv;			//////VISUALIZAÇÃO DISCIPLINA - PRINCIPAL: page-atv ///////
		...
		success: function(json){
			...
			if(dados_config["REDIRECT"] != 'undefined' && dados_config["REDIRECT"] != '0'){		
...
function menu_inicial() {
	if(page == 'page-inicial-ios-tablet-desktop.html'){
		...
		if(dados_config['session_mat_cp_id'] == 2){
			var item8 = 'Colégio SESI';
			var url8 = 'https://www.facebook.com/colegiosesi/?fref=ts/';
			
			var item9 = 'SuperYouTube';
			var url9 = 'https://www.youtube.com/channel/UCAdIUKWPYRq3TMrbc7Ixq1Q/';
		} 
		...
		if(url1 != '' && item1 != '')menu_frd += '<li><a class="menu_ios_desk" href="'+url1+'" onClick="change_menu()" >'+item1+'</a></li>';
		if(url2 != '' && item2 != '')menu_frd += '<li><a class="menu_ios_desk"  href="'+url2+'" onClick="change_menu()" target = "_blank">'+item2+'</a></li>';
		if(url3 != '' && item3 != '')menu_frd += '<li><a class="menu_ios_desk"  href="'+url3+'" onClick="change_menu()" target = "_blank">'+item3+'</a></li>';
		if(url4 != '' && item4 != '')menu_frd += '<li><a class="menu_ios_desk"  href="'+url4+'" onClick="change_menu()" >'+item4+'</a></li>';
		if(url5 != '' && item5 != '')menu_frd += '<li><a class="menu_ios_desk"  href="'+url5+'" onClick="change_menu()"  target = "_blank">'+item5+'</a></li>';
		if(url6 != '' && item6 != '')menu_frd += '<li><a class="menu_ios_desk"  href="'+url6+'" onClick="change_menu()"  target = "_blank">'+item6+'</a></li>';
		if(url7 != '' && item7 != '')menu_frd += '<li><a class="menu_ios_desk"  href="'+url7+'" onClick="change_menu()" target = "_blank">'+item7+'</a></li>';
		if(url8 != '' && item8 != '')menu_frd += '<li><a class="menu_ios_desk"  href="'+url8+'" onClick="change_menu()" >'+item8+'</a></li>';
		if(url9 != '' && item9 != '')menu_frd += '<li><a class="menu_ios_desk"  href="'+url9+'" onClick="change_menu()" >'+item9+'</a></li>';
		menu_frd += '</ul></div></nav>';
